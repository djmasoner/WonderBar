...
table_attributes = {
	...
	"prompts" : ["project_id", "subheading", "description", "response_type_id", "instructions_media", "media_type"],
	"multientry_items" : ["prompt_id", "entry_text"],
	"observations": ["user_id", "prompt_id", "response", "location", "additional_notes"],
...
table_attributes_optional = {
	...
	"prompts" : ["subheading", "instructions_media", "media_type"],
	"multientry_items" : [],
	"observations": ["location", "additional_notes"],
	"classes": [],
	"enrollments": [],
	"materials": []
}
...
table_updates = {
	...
	"project_locations" :[],
	"response_types" : ["name", "can_multi_select"],
	"prompts" : ["subheading", "description", "response_type_id", "instructions_media", "media_type"],
...
table_fks = {
	...
	"projects_classes" : ["project_classes", "class_id", "project_id"],
	"classes_projects" : ["project_classes", "project_id", "class_id"],
...
table_joins = {
	...
	"project_topics":["projects", "classes", "project_id", "class_id"],
