	...
	function getProjectTopics() {
		...
		.then(topics => {
			...
			label.innerHTML = "Select topics (must select at least 1) *:";
			p.appendChild(label);
			row.appendChild(p);
	...
	function getProjectClasses() {
		...
		.then(classes => {
			...
			p = document.createElement("p");
			var label = document.createElement("label");
			label.innerHTML = "Select classes (must select at least 1) *:";
			p.appendChild(label);
			row.appendChild(p);
	...
	function getProjectLocations() {
		...
		.then(locations => {
			...
			p = document.createElement("p");
			var label = document.createElement("label");
			label.innerHTML = "Select locations (must select at least 1) *:";
			p.appendChild(label);
			row.appendChild(p);
